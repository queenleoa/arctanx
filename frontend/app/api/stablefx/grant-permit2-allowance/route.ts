...
// Max uint256 for unlimited allowance (decimal string for Circle SDK)
const MAX_ALLOWANCE = '115792089237316195423570985008687907853269984665640564039457584007913129639935'; // 2^256 - 1
